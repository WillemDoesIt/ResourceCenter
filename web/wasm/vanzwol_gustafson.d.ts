...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h656ec775bb96232e: (a: number, b: number) => void;
